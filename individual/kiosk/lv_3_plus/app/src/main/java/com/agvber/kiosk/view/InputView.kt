    ...
    fun inputFrozenCustardMenu(): String {
        println(
            "[ Frozen Custard MENU ]\n" +
                    ...
                    "4. Mint Chocolate BonBon        | W 2.9 | 민트 아이스크림에 달콤한 초콜릿칩과 봉봉 프레첼 볼이 가득!\n" +
                    "5. Mango Tango                  | W 3.4 | 부드럽고 상큼한 열대과일, 입 안 가득 진한 망고 향이 가득!\n" +
                    "0. 뒤로가기                      | 뒤로가기"
        )
        return readln()
    }
    ...
    fun inputDrinksMenu(): String {
        println(
            "[ Drinks MENU ]\n" +
                    ...
                    "4. Fanta      | W 2.9 | 환타의 상큼하고 재미있는 맛을 만나보세요. 환타 파인애플, 오렌지, 포도, 밀크소다와 같은 클래식 소프트 드링크가 모든 연령층에게 사랑받고 있습니다.\n" +
                    "5. Dr Pepper  | W 1.4 | 1885년 탄생한 닥터페퍼는 독특한 맛과 톡 쏘는 탄산으로 마실수록 빠져드는 경험을 선사합니다.\n" +
                    "0. 뒤로가기    | 뒤로가기"
        )
        return readln()
    }
    ...
    fun inputBeerMenu(): String {
        println(
            "[ Beer MENU ]\n" +
                    ...
                    "4. Kirin      | W 2.9 | 라벨을 보면 맛이 보인다 보리 100%의 첫즙만 담은 단 하나의 맛\n" +
                    "5. TERRA      | W 1.4 | 이 맛이 청정라거다!\n" +
                    "0. 뒤로가기    | 뒤로가기"
        )
        return readln()
    }
